const projects = [
  {
    ...
    description:
      'TIL was my apprentice project at Hashrocket. It has grown into a popular developers blog with 2000+ posts, millions of page views per year, the top-ranked answers on Google to many esoteric developer questions. It is also open-source, one of the first such server-rendered Phoenix application repositories available online. I, and members of my team, used TIL to learn Elixir and develop our growing Elixir practice.',
    purpose:
    ...
    stackExplanation:
      'TIL started out was a Ruby on Rails app. In 2016, I initiated an Elixir rewrite because I wanted to have an Elixir project to work on.',
